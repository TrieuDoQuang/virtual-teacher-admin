...
export async function recommendLesson(prompt: string) {
  const response: Response<Lesson> = await apiPrivate.post(
...
export async function deleteLesson(lessonIds: string[]) {
  const response: Response<Lesson> = await apiPrivate.delete(
...
export async function updateLesson(lesson: Lesson) {
  ...
  const response: Response<Lesson> = await apiPrivate.put(
    "/lesson/updateLesson",
    lesson
  );
  return response?.data;
